...
class LoginVM {
  bool isLoading;
  AuthState authState;
  final Function(BuildContext, String) onLoginPressed;
  ...
  static LoginVM fromStore(Store<AppState> store) {
    return LoginVM(
        ...
        onLoginPressed: (BuildContext context, String phoneNumber) {
          if (store.state.isLoading) {
            return;
          }
          final Completer<Null> completer = new Completer<Null>();
          store.dispatch(UserLoginRequest(completer, phoneNumber.trim()));
